...
const FEATURES: { emoji: string; title: string; desc: string; href?: string; tag?: string; pricing?: 'free' | 'mixed'; priceNote?: string }[] = [
    ...
    { emoji: '🤝', title: '함께 암송', pricing: 'free', desc: '전원이 완료해야 내일이 열리는 암송', href: '/tutorial/memorization' },
        ...
        <div style={S.page}>
            <div style={S.wrap}>
                ...
                <div style={S.legend}>
                    ...
                    <span style={S.badgePremium}>무료+프리미엄 — 핵심은 무료, 일부만 프리미엄 (월 $1.49)</span>
                </div>
                <div style={S.grid}>
                    {FEATURES.map((f) => (
                        f.href ? (
                            <Link key={f.title} href={f.href} style={S.card}>
                                ...
                                <div style={S.priceRow}>
                                    <span style={f.pricing === 'mixed' ? S.priceMixed : S.priceFree}>{f.pricing === 'mixed' ? '무료+프리미엄' : '무료'}</span>
