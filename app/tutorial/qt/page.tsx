    ...
    return (
        <div style={S.page}>
            <div style={S.wrap}>
                ...
                <h2 style={S.h2}>큐티 내용은 어디에서 왔나요?</h2>
                <div style={S.card}>
                    <ul style={S.ul}>
                        <li><b>성경 본문</b> — 한국어는 <b>개역한글판</b>(대한성서공회 정식 라이선스 계약),
                            영어는 <b>WEB</b>(World English Bible), 일본어는 <b>口語訳</b> 성경에서 그대로 가져옵니다.
                            묵상의 중심은 언제나 성경 본문 그 자체예요.</li>
                        <li><b>묵상·적용·기도</b> — 그날의 성경 본문에서 출발해 soluma 팀이 365일 전체를 직접 제작하며,
                            <b> 자문 목회자들의 검수 방향</b> 아래 제작·운영됩니다.</li>
                        <li>모든 콘텐츠는 <b>성경을 중심으로</b> 기독교 신앙의 본질을 추구하며,
                            <b> 이단적 해석을 배제</b>하도록 만들어집니다. (앱의 &lsquo;soluma가 지키는 것&rsquo; 원칙과 동일)</li>
                        <li>매일 큐티에는 <b>본문 구절 표기</b>(예: 시편 23:1-6)가 함께 있어,
                            성경 읽기에서 원문 전체를 언제든 직접 대조해볼 수 있어요.</li>
                    </ul>
                </div>
