...
export const metadata: Metadata = {
    ...
    description: '기도제목을 나누고 서로 중보하는 기도 피드. 사용법과 프리미엄 안내.',
};
        ...
        <div style={S.page}>
            <div style={S.wrap}>
                ...
                <table style={S.table}>
                    ...
                    <tbody>
                        <tr><td style={S.td}>기도 피드 열람 · 기도제목 작성 · [기도합니다] · 댓글</td><td style={S.td}><span style={S.badgePremium}>프리미엄</span></td></tr>
                    </tbody>
                </table>
                <p style={{ ...S.p, fontSize: 13.5, color: '#94a3b8', marginTop: 8 }}>
                    · 기도는 <span style={S.badgePremium}>프리미엄</span> 전용 기능이에요. 아직 구독 전이라면 화면에 들어갈 때 구독 안내가 먼저 나오고,
