...
export const metadata: Metadata = {
    ...
    description: '아는 사람들과 소그룹을 만들어 기도제목·나눔·채팅을 함께하는 소그룹. 사용법과 무료 안내.',
};
        ...
        <div style={S.page}>
            <div style={S.wrap}>
                ...
                <table style={S.table}>
                    ...
                    <tbody>
                        <tr><td style={S.td}>소그룹 만들기 · 초대 참여 · 기도제목 · 나눔 · 채팅</td><td style={S.td}><span style={S.badgeFree}>무료</span></td></tr>
                    </tbody>
                </table>
                <p style={{ ...S.p, fontSize: 13.5, color: '#94a3b8', marginTop: 8 }}>
                    · 소그룹은 전부 무료로 이용할 수 있어요.
                </p>
