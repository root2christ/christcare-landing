...
export const metadata: Metadata = {
    ...
    description: '월요일부터 요일마다 한 절씩, 다 같이 외우는 함께 암송. 시작 방법과 하루 사용법 안내.',
};
        ...
        <div style={S.page}>
            <div style={S.wrap}>
                ...
                <p style={S.lead}>
                    ...
                    같은 말씀을 <b>매일 함께</b> 외우고, 서로의 목소리를 들으며 나아가는 말씀 암송입니다.
                ...
                <div style={S.card}>
                    <ul style={S.ul}>
                        <li><b>요일이 곧 진도</b>예요 — 월 1절 · 화 2절 · 수 3절 · 목 4절 · 금 5절, 토요일은 복습, 일요일은 쉼. 달력만 보면 오늘 뭘 할지 알 수 있어요.</li>
                        <li><b>새 구절은 월요일에 열려요.</b> 주 중에 들어오면 그날 요일의 절부터 시작합니다 — 처음부터 몰아서 할 필요가 없어요.</li>
                        <li><b>서로를 기다려요.</b> 오늘 몫은 <b>다음 날 새벽 2시까지</b> 할 수 있고, 그 시각이 지나면 방은 함께 다음 날로 넘어갑니다. 한 사람 때문에 모두가 멈추는 일은 없어요.</li>
                        <li><b>못 한 절은 언제든 채울 수 있어요.</b> 오늘 것을 막지 않고, 하고 싶을 때 고르면 됩니다. 안 해도 괜찮아요.</li>
                        <li><b>지난 2주 본문을 매일 함께 복습</b>(누적)해서, 외운 말씀이 잊히지 않아요. 토요일 복습은 <b>이번 주 전체</b>와 <b>내가 시작한 절부터</b> 중에 고를 수 있어요.</li>
                        <li>완료 인증은 <b>녹음 제출</b> — 멤버끼리 서로의 녹음을 들으며 격려할 수 있어요. 아직 안 한 멤버는 <b>콕 찌르기</b>(하루 1번)로 살짝 깨워줄 수도 있고요.</li>
                ...
                <div style={S.step}>
                    ...
                    <div style={S.stepText}>
                        ...
                        <p style={S.p}>
                            ...
                            → <b>녹음 제출</b>. 녹음이 제출되면 오늘 완료! 전원이 마치면 그날 바로 축하가 오고,
                            아직인 사람이 있어도 <b>다음 날 새벽 2시</b>가 지나면 함께 다음 날로 넘어가요.
                        </p>
                    </div>
                </div>
