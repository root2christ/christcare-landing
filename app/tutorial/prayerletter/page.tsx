    ...
    return (
        <div style={S.page}>
            <div style={S.wrap}>
                ...
                <p style={S.lead}>
                    <b>마음을 담아 기도를 편지로 써서 보내는</b> 기능입니다.
                    급하게 흘려보내는 기도가 아니라, 편지를 쓰듯 정성껏 눌러 쓴 기도가
                    받는 사람에게 전해집니다.
                </p>
                ...
                <div style={S.card}>
                    <ul style={S.ul}>
                        <li>기도를 <b>편지 형식으로 정성껏</b> 써서 전할 수 있어요.</li>
                ...
                <table style={S.table}>
                    ...
                    <tbody>
                        <tr><td style={S.td}>기도 편지 읽기</td><td style={S.td}><span style={S.badgeFree}>무료</span></td></tr>
                        <tr><td style={S.td}>기도 편지 쓰기 · 보내기</td><td style={S.td}><span style={S.badgeFree}>무료</span></td></tr>
                        <tr><td style={S.td}>함께 기도하기 · 공유</td><td style={S.td}><span style={S.badgeFree}>무료</span></td></tr>
                    </tbody>
                </table>
